...
import pyflann
import time
from lib.fuzzer import generation_based_Fuzzer
from lib.generate_input import generate_mnist_input
...
tf.flags.DEFINE_integer('low', -1, 'minimum range of input_elements')
tf.flags.DEFINE_integer('high', 1, 'maximum range of input_elements')
...
def main(_):
    ...
    with tf.Session() as sess:
        ...
        generation_function = generate_mnist_input(low=FLAGS.low, high=FLAGS.high, size=size)  # 数据生成方法
