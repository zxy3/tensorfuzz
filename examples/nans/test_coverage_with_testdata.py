...
def main(_):
    ...
    with tf.Session() as sess:
        ...
        for index in range(len(elements)):
            ...
            hidden_1_list.append(elements[index].hidden_layer_1_after_activation[0][0].tolist())
            hidden_2_list.append(elements[index].hidden_layer_2_after_activation[0][0].tolist())
        ...
        '''
              output_layer k_multisection coverage: 0.98
              output_layer neuron_boundary coverage: 0.05
              k_multisection coverage: 0.983225806451613
              neuron boundary coverage: 0.17096774193548386
              strong neuron activation coverage: 0.18387096774193548
              top-k neuron coverage: 0.5451612903225806
              top-k patterns: 8181
              '''


        # print(len(mutated_hidden_1_list))
        # print(len(mutated_hidden_1_list[0]))
        # # print(mutated_hidden_1_list[0])
        # print(type(mutated_hidden_1_list))
        # print(mutated_hidden_1_list[0])
        ...
        # print("=============================================")
        #
        # print(len(reverse_hidden_1_list))
        # print(len(reverse_hidden_1_list[0]))
        #
        # print(len(reverse_hidden_2_list))
        # print(len(reverse_hidden_2_list[0]))
        #
        # print(len(reverse_output_list))
        # print(len(reverse_output_list[0]))
