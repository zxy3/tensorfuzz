...
tf.flags.DEFINE_string(
    "checkpoint_dir", "/tmp/testfuzzer", "Dir containing checkpoints of model to fuzz."  # 包含模型检查点的目录
)
tf.flags.DEFINE_integer(
    "total_inputs_to_fuzz", 10000, "Loops over the whole corpus."  # 循环数
)
tf.flags.DEFINE_integer(
