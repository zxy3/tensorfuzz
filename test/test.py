...
#
# # remove_indexes = find_remove_indexes([2, 5, 8], [6, 9])
# remove_indexes = find_remove_indexes([], [])
# print(remove_indexes)
# # print(remove_alternative_indexed)
# # print(help_indexes)
#
# # remove_indexes = []
# # if remove_alternative_indexed:
# #     for item in help_indexes:
# #         sub_indexes = []
# #         for i in range(len(item)):
# #             sub_indexes.append(remove_alternative_indexed[i][item[i]])
# #         remove_indexes.append(sub_indexes)
#
...
#             if sub_strs[i][::-1] == sub_strs[i]:
#                 if max_length < len(sub_strs[i]):
#                     max_length = len(sub_strs[i])
#                     max_index = i
#         return sub_strs[max_index]
...
#         if max_sum == 1:
#             return s[0]
#         index = flag.index(max_sum)
#         print(index)
#         if index % 2 != 0:
#             return s[index // 2 - max_sum // 2 + 1: index // 2 + max_sum // 2 + 1]
#         else:
#             return s[index // 2 - (max_sum - 1) // 2: index // 2 + (max_sum - 1) // 2 + 1]
# s = Solution()
...
#         if numRows == 1:
#             return s
#         cycle_num = numRows * 2 - 2
#         middle_num = numRows - 2
#         str_split_by_row = [[] for row in range(numRows)]
#         # print(str_split_by_row)
#         for i in range(len(s)):
#             mod = i % cycle_num
#             for j in range(cycle_num):
#                 if mod == j:
#                     if mod == 0:
#                         # print(s[i], '在第', mod + 1, '行')
#                         str_split_by_row[mod].append(s[i])
#                         # str_split_by_row[mod].append(' ' * (numRows - middle_num))
#                     elif mod == numRows - 1:
#                         # print(s[i], '在第', mod + 1, '行')
#                         str_split_by_row[mod].append(s[i])
#                         # str_split_by_row[mod].append(' ' * (numRows - middle_num))
#                     elif mod > 0 and mod < numRows - 1:
#                         # print(s[i], '在第', mod + 1, '行')
#                         str_split_by_row[mod].append(s[i])
#                         # str_split_by_row[mod].append(' ' * (numRows - middle_num - mod))
#                     else:
#                         # print(s[i], '在第', cycle_num - mod + 1, '行')
#                         str_split_by_row[cycle_num - mod].append(s[i])
#                         # str_split_by_row[cycle_num - mod].append(' ' * (cycle_num - 1 - mod))
#         result = ''
#         for item in str_split_by_row:
#             str_ = ''.join(item)
#             result += str_
#         return result
# solution = Solution()
...
#
# s = Solution()
# print(s.reverse(99999999999999999999999999999999))
#
# class Solution:
#     def myAtoi(self, str):
#         """
...
#             else:
#                 str_ = str_[1:]
#         elif str_[0] not in num_str:
#             return 0
#
#         i = 0
#         while i < len(str_):
#             if str_[i] in num_str:
#                 result += str_[i]
#                 i += 1
#             else:
#                 break
...
#             remove_indexes.append(sub_indexes)
#     return remove_indexes
# # print(find_remove_indexes([1,2,3], [4, 5, 6]))
#
# class Solution:
...
#     remove_indexes = []
    ...
    #     sub_list = [list2[i], list2[i] + 1]
    #     remove_alternative_indexes.append(sub_list)
#     remove_alternative_indexes = [[1, 2], [3, 4], [5, 6]]
#      # print(remove_alternative_indexes)
#     help_indexes = []
#     for i in range(pow(2, len(remove_alternative_indexes))):
#         help_index_before_process = str(bin(i))[2:]
...
#                 # else:
#                 #     break
#                 need_num = 0 - nums[i] - nums[j]
#                 left = j + 1
#                 right = len(nums) - 1
#                 while left <= right:
#                     mid = (left + right) // 2
#                     if need_num > nums[mid]:
#                         left = mid + 1
#                     elif need_num < nums[mid]:
#                         right = mid - 1
#                     else:
#                         sub_result = [nums[i], nums[j], need_num]
#                         if sub_result not in result:
#                             result.append(sub_result)
#                         break
#
...
class Solution:
    def threeSumClosest(self, nums, target):
        ...
        i = 0
        while i < len(nums) - 2:
            # if abs(target - nums[i]) > difference:
            #     break
            j = i + 1
            while j < len(nums) - 1:
                # if abs(target - nums[i] - nums[j]) > difference:
                #     break
                k = j + 1
                while k < len(nums):
                    # if abs(target - nums[i] - nums[j] - nums[k]) > difference:
                    #     break
                    if nums[i] + nums[j] + nums[k] == target:
                        return target
                    elif nums[i] + nums[j] + nums[k] < target:
                        this_difference = abs(target - nums[i] - nums[j] - nums[k])
