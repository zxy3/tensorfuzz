...
from examples.mytest.keras_adversarial.image_grid_callback import ImageGridCallback
from examples.mytest.keras_adversarial import AdversarialModel, simple_gan, gan_targets
from examples.mytest.keras_adversarial import normal_latent_sampling, AdversarialOptimizerSimultaneous
from examples.mytest.keras_adversarial.legacy import l1l2, Dense, fit
import keras.backend as K
from examples.mytest.mnist_utils import mnist_data
